  ...
  return (
    <div className="font-serif bg-[#f5f3f5]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24">
        <div className="flex flex-col-reverse md:flex-col-reverse  lg:flex-row md items-center justify-between">

        <div className="w-full  md:mb-[39px]  ">
            <h2 className="text-2xl md:text-[36px] lg:text-[48px] text-gray-800 font-400 md:text-center lg:text-start mb-4 flex justify-center lg:justify-start ">
              Join our  <span className="text-orange-500 ml-2">Hacker House</span>
            </h2>
            <p className="text-base md:text-[14px] lg:text-[16px] font-300 md:w-full   lg:h-[57px] md:h-[34px] text-gray-600 lg:mb-[48px] md:mb-[20px] ">
